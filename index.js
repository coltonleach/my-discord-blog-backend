...
useEffect(() => {
  ...
  },
  {
    ...
    body: [
      ...
      `More familiarity with React hooks such as useRef, useContext, useEffect, and custom hooks. Obviously this is an insaely key aspect of React, and will only further strengthen my foundation. I have used each of these before, but my understanding is quite limited, and my main priority amongst these is useContext and useEffect. useContext is a requirement for a proper user authentication experience. I listed useEffect specifically because I want to get a better understanding of a components lifecycle, specifically unmounting. I plan on simply studying each of these hooks while using them in my applications.`,
